...
// $Id: dywTorusStack.hh 882 2006-04-14 14:49:54Z caoj $
//
...
//
// dywTorusStack(const G4String      &pName )
//
...
//   
//
// 1999.11.22 G.Horton-Smith First version of dywTorusStack


#ifndef dywTorusStack_HH
#define dywTorusStack_HH

#include "G4CSGSolid.hh"

class dywTorusStack : public G4CSGSolid {
public:
    dywTorusStack(const G4String &pName);

    virtual ~dywTorusStack();
    ...
    void SetAllParameters(G4int n,                   // number of Z-segments
			  ...
			  dywTorusStack *inner=0);    // inner TorusStack (opt.)
...
protected:
    ...
    dywTorusStack *inner;  // because G4SubtractionSolid is bad
};
