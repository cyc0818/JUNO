#ifndef R12860OnlyFrontMaskManager_hh
#define R12860OnlyFrontMaskManager_hh
...
class R12860OnlyFrontMaskManager : public IPMTElement,
                            public ToolBase{
public:
    ...
    R12860OnlyFrontMaskManager(const std::string& name);
    ~R12860OnlyFrontMaskManager();
...
private:
    G4String GetName() { return objName();}
