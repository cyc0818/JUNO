...
NNVTMaskManager::makeMaskLogical() {
    ...
    else if(hasOpt("U1") || hasOpt("U2"))
    {
        MaskIn_uncoincide_z = 1.0*mm ; 
        std::cout << "NNVTMaskManager::makeMaskLogical hasOpt U1/U2 : MaskIn_uncoincide_z " << MaskIn_uncoincide_z << std::endl ; 
    } 
#endif
...
NNVTMaskManager::makeMaskTailLogical() {
    ...
    //double outer_pzBottomCut = -htop_out ; 
    double outer_pzBottomCut = -(height_out+paramRealMaskTail.height) ;  

#ifdef PMTSIM_STANDALONE
    if(hasOpt("U2")) outer_pzBottomCut = -htop_out ;  // U2:revert to bug #32
#endif
    ...
    addValue("SolidMaskTail.TailOuterIEllipsoid.pzBottomCut.-(height_out+paramRealMaskTail.height)",
                                                            -(height_out+paramRealMaskTail.height) ) ; 
    addValue("SolidMaskTail.TailOuterIEllipsoid.pzBottomCut.outer_pzBottomCut", outer_pzBottomCut ) ; 
    ...
    double inner_pzBottomCut = -(height_out+paramRealMaskTail.height-htop_thickness) ;
#ifdef PMTSIM_STANDALONE
    if(hasOpt("U2")) inner_pzBottomCut = -htop_in ;  // U2:revert to bug #32 
#endif
    ...
    addValue("SolidMaskTail.TailInnerIEllipsoid.pzBottomCut.-(height_out+paramRealMaskTail.height-htop_thickness)",
                                                            -(height_out+paramRealMaskTail.height-htop_thickness) ) ; 
    addValue("SolidMaskTail.TailInnerIEllipsoid.pzBottomCut.inner_pzBottomCut", inner_pzBottomCut ) ; 
    addValue("SolidMaskTail.TailInnerIEllipsoid.pzTopCut.-height_out", -height_out ) ; 
#endif



    G4double TailInnerI_uncoincide_z = 1.0*mm ; 
#ifdef PMTSIM_STANDALONE
    if(hasOpt("U0"))
    {
