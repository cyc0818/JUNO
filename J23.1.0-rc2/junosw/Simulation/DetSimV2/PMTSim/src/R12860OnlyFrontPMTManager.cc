...
#include "R12860OnlyFrontPMTManager.hh"
...
DECLARE_TOOL(R12860OnlyFrontPMTManager);

// Interface
G4LogicalVolume* 
R12860OnlyFrontPMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4double
R12860OnlyFrontPMTManager::GetPMTRadius() {
    if (!getLV()) {
...
G4double
R12860OnlyFrontPMTManager::GetPMTHeight() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_pmt_h;
...
G4double
R12860OnlyFrontPMTManager::GetZEquator() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_z_equator;
...
G4ThreeVector
R12860OnlyFrontPMTManager::GetPosInPMT() {
    G4ThreeVector rndm_pos;
    return rndm_pos;
}

// Constructor
R12860OnlyFrontPMTManager::R12860OnlyFrontPMTManager
...
// Helper Methods
void
R12860OnlyFrontPMTManager::init() {
...
void
R12860OnlyFrontPMTManager::init_material() {
...
void
R12860OnlyFrontPMTManager::init_variables() {
    m_pmt_r = 254.*mm;
    m_pmt_h = 523.*mm;
    m_z_equator = 184.*mm; // From top to equator

    G4cout << __FILE__ << ":" << __LINE__ << std::endl;
    m_pmtsolid_maker = new R12860OnlyFront_PMTSolid(
                            m_pmt_r,
                            m_z_equator, // z front
                            -10.*mm       // z back (guess). NOTE: it should be nagative.
                            );
}

void
R12860OnlyFrontPMTManager::init_mirror_surface() {
...
void
R12860OnlyFrontPMTManager::init_pmt() {
...
void 
R12860OnlyFrontPMTManager::helper_make_solid() 
{
...
void
R12860OnlyFrontPMTManager::helper_make_logical_volume()
{
...
void
R12860OnlyFrontPMTManager::helper_make_physical_volume()
{
...
void
R12860OnlyFrontPMTManager::helper_make_optical_surface()
{
...
void
R12860OnlyFrontPMTManager::helper_fast_sim()
{
...
void
R12860OnlyFrontPMTManager::helper_vis_attr()
{  
...
void
R12860OnlyFrontPMTManager::init_cover() {
    // solid
