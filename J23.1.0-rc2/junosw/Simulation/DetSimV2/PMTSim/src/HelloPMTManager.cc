...
DECLARE_TOOL(HelloPMTManager);

// Interface
G4LogicalVolume* 
HelloPMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4ThreeVector
HelloPMTManager::GetPosInPMT() {
    G4ThreeVector rndm_pos;
    return rndm_pos;
}

// Constructor
HelloPMTManager::HelloPMTManager
...
void
HelloPMTManager::init_variables() {
    m_pmt_r = 254.*mm;
    m_pmt_h = 700.*mm;
...
void
HelloPMTManager::init_mirror_surface() {
...
void 
HelloPMTManager::helper_make_solid() 
{
...
void
HelloPMTManager::helper_make_logical_volume()
{
...
void
HelloPMTManager::helper_make_physical_volume()
{
...
void
HelloPMTManager::helper_make_optical_surface()
{
...
void
HelloPMTManager::helper_fast_sim()
{
...
void
HelloPMTManager::helper_vis_attr()
{  
