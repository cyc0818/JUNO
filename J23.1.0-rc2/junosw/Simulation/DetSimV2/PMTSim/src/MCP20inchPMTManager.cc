...
#include "MCP20inchPMTManager.hh"
...
DECLARE_TOOL(MCP20inchPMTManager);

// Interface
G4LogicalVolume* 
MCP20inchPMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4double
MCP20inchPMTManager::GetPMTRadius() {
    return m_pmt_r;
}

G4double
MCP20inchPMTManager::GetPMTHeight() {
    return m_pmt_h;
}

G4double
MCP20inchPMTManager::GetZEquator() {
    return m_z_equator;
}

G4ThreeVector
MCP20inchPMTManager::GetPosInPMT() {
...
// Constructor
MCP20inchPMTManager::MCP20inchPMTManager
...
void
MCP20inchPMTManager::init_material() {
...
void
MCP20inchPMTManager::init_variables() {
    m_pmt_r = 254.*mm;
    m_pmt_h = 523.*mm;
...
void
MCP20inchPMTManager::init_mirror_surface() {
...
void 
MCP20inchPMTManager::helper_make_solid() 
{
...
void
MCP20inchPMTManager::helper_make_logical_volume()
{
...
void
MCP20inchPMTManager::helper_make_physical_volume()
{
...
void
MCP20inchPMTManager::helper_make_optical_surface()
{
...
void
MCP20inchPMTManager::helper_fast_sim()
{
...
void
MCP20inchPMTManager::helper_vis_attr()
{  
...
void
MCP20inchPMTManager::init_cover() {
    // solid
