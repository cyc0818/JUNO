...
#include "Tub3inchPMTV2Manager.hh"
...
DECLARE_TOOL(Tub3inchPMTV2Manager);

// Interface
G4LogicalVolume* 
Tub3inchPMTV2Manager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4double
Tub3inchPMTV2Manager::GetPMTRadius() {
    if (!getLV()) {
...
G4double
Tub3inchPMTV2Manager::GetPMTHeight() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_pmt_h;
...
G4double
Tub3inchPMTV2Manager::GetZEquator() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_z_equator;
...
G4ThreeVector
Tub3inchPMTV2Manager::GetPosInPMT() {
    G4ThreeVector rndm_pos;
    return rndm_pos;
}

// Constructor
Tub3inchPMTV2Manager::Tub3inchPMTV2Manager
...
void
Tub3inchPMTV2Manager::init_material() {
...
void
Tub3inchPMTV2Manager::init_variables() {
    m_pmt_r = 254.*mm/6.6;
    // m_pmt_h = 660.*mm/6.6;
    m_pmt_h = 2.*mm;
    /// double m_pmt_H = 40.*mm;
    double m_pmt_H = 200.*mm;

    m_pmtsolid_maker = new Tub3inchPMTV2Solid(
                            m_pmt_r,
                            m_pmt_h,
                            m_pmt_H
                            );
...
void
Tub3inchPMTV2Manager::init_mirror_surface() {
...
void 
Tub3inchPMTV2Manager::helper_make_solid() 
{
    ...
    G4double helper_sep_tube_r = m_pmt_r - 1*mm;// explict decrease the size
    G4double helper_sep_tube_hh = m_pmt_h/2;
    // G4double helper_sep_tube_hh = 0.1*mm;
    ...
    G4VSolid * pInnerSep = new G4Tubs("Inner_Separator",
            ...
            0.,360.*degree);
    G4ThreeVector innerSepDispl(0.,0.,helper_sep_tube_hh);
...
void
Tub3inchPMTV2Manager::helper_make_logical_volume()
{
...
void
Tub3inchPMTV2Manager::helper_make_physical_volume()
{
...
void
Tub3inchPMTV2Manager::helper_make_optical_surface()
{
...
void
Tub3inchPMTV2Manager::helper_fast_sim()
{
...
void
Tub3inchPMTV2Manager::helper_vis_attr()
{
