...
DECLARE_TOOL(HZC9inchPMTManager);

// Interface
G4LogicalVolume* 
HZC9inchPMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4double
HZC9inchPMTManager::GetPMTRadius() {
    return m_pmt_r;
}

G4double
HZC9inchPMTManager::GetPMTHeight() {
    return m_pmt_h;
}

G4double
HZC9inchPMTManager::GetZEquator() {
    return m_z_equator;
}

G4ThreeVector
HZC9inchPMTManager::GetPosInPMT() {
...
// Constructor
HZC9inchPMTManager::HZC9inchPMTManager
...
void
HZC9inchPMTManager::init_material() {
     ...
     Photocathode_opsurf->SetMaterialPropertiesTable(G4Material::GetMaterial("photocathode_HZC9inch")->GetMaterialPropertiesTable() );
...
void
HZC9inchPMTManager::init_variables() {
    m_pmt_r = 114.*mm;
    m_pmt_h = 256.*mm;
    m_z_equator = 89.36*mm; // From top to equator
...
void
HZC9inchPMTManager::init_mirror_surface() {
...
void 
HZC9inchPMTManager::helper_make_solid() 
{
    ...
    //G4double helper_sep_tube_r = 103.*mm;
    //G4double helper_sep_tube_h = 51.06*mm;
...
void
HZC9inchPMTManager::helper_make_logical_volume()
{
...
void
HZC9inchPMTManager::helper_make_physical_volume()
{
...
void
HZC9inchPMTManager::helper_make_optical_surface()
{
...
void
HZC9inchPMTManager::helper_fast_sim()
{
...
void
HZC9inchPMTManager::helper_vis_attr()
{  
