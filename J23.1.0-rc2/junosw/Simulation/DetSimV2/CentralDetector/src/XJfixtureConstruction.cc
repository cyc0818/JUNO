...
void XJfixtureConstruction::initVariables(){
   ...
   m_xjfixture_pos = radAcrylic + 10.*mm + 13./2*mm ;
}
...
// cover part
    ...
    solidXJfixture_up_uni1 = new G4UnionSolid("solidXJfixture_up_uni1", solidXJfixture_up1, solidXJfixture_up2, 0, G4ThreeVector(0.*mm, 0.*mm, 13.5*mm));
    
    solidXJfixture_up3 = new G4Box("solidXJfixture_up3", 20.*mm, 11*mm, 11.*mm);
    solidXJfixture_up_uni2 = new G4SubtractionSolid("solidXJfixture_up_uni2",solidXJfixture_up_uni1, solidXJfixture_up3 ,0, G4ThreeVector(0.*mm, 0.*mm, 17/2.0*mm));//make a hole 

// union 
    solidXJfixture = new G4UnionSolid("solidXJfixture", solidXJfixture_down_uni4, solidXJfixture_up_uni2, 0, G4ThreeVector(0.*mm, 0.*mm, -25.*mm));
...
double XJfixtureConstruction::geom_info(const std::string& param) {
    if (param == "PosR") {
        return m_xjfixture_pos;
    }
    return 0.0;
}   
