#include "CalibTube_offcenter_Construction.hh"
...
DECLARE_TOOL(CalibTube_offcenter_Construction);

CalibTube_offcenter_Construction::CalibTube_offcenter_Construction(const std::string& name)
    : ToolBase(name)
      , solidCT(0), logicCT(0)
...
CalibTube_offcenter_Construction::~CalibTube_offcenter_Construction() {

}

G4LogicalVolume*
CalibTube_offcenter_Construction::getLV() {
    if (logicCT) {
        return logicCT;
    }
...
bool
CalibTube_offcenter_Construction::inject(std::string motherName, IDetElement* other, IDetElementPos* pos) {
    return true;
}

void
CalibTube_offcenter_Construction::initVariables() {
...
void 
CalibTube_offcenter_Construction::initMaterials() {
    // Xin Qian added Nov 2nd 2014 
...
void
CalibTube_offcenter_Construction::makeCTLogical() {
  // main CT tube volume
