#include "CalibTube_twocone_Construction.hh"
...
DECLARE_TOOL(CalibTube_twocone_Construction);

CalibTube_twocone_Construction::CalibTube_twocone_Construction(const std::string& name)
    : ToolBase(name)
      , solidCT(0), logicCT(0)
...
CalibTube_twocone_Construction::~CalibTube_twocone_Construction() {

}

G4LogicalVolume*
CalibTube_twocone_Construction::getLV() {
    if (logicCT) {
        return logicCT;
    }
...
bool
CalibTube_twocone_Construction::inject(std::string motherName, IDetElement* other, IDetElementPos* pos) {
    return true;
}

void
CalibTube_twocone_Construction::initVariables() {
...
void 
CalibTube_twocone_Construction::initMaterials() {
    // Xin Qian added Nov 2nd 2014 
...
void
CalibTube_twocone_Construction::makeCTLogical() {
  // main CT tube volume
