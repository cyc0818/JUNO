...
#ifndef LSExpMTPrimaryGeneratorAction_h
#define LSExpMTPrimaryGeneratorAction_h 1
...
class LSExpMTPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
public:
  LSExpMTPrimaryGeneratorAction();
  ~LSExpMTPrimaryGeneratorAction();
