...
struct G4GenStep: IGenStep {
    ...
    // pre_beta
    virtual double pre_beta() {
        return m_container.pre_beta(m_idx);
    }
    virtual void pre_beta(double val) {
        m_container.pre_beta(m_idx, val);
    }


    // post_beta
    virtual double post_beta() {
        return m_container.post_beta(m_idx);
    }
    virtual void post_beta(double val) {
        m_container.post_beta(m_idx, val);
    }

    // num_ceren
    virtual double num_ceren() {
        return m_container.num_ceren(m_idx);
    }
    virtual void num_ceren(double val) {
        m_container.num_ceren(m_idx, val);
    }

    virtual double num_ceren_1() {
        return m_container.num_ceren_1(m_idx);
    }
    virtual void num_ceren_1(double val) {
        m_container.num_ceren_1(m_idx, val);
    }

    virtual double num_ceren_2() {
        return m_container.num_ceren_2(m_idx);
    }
    virtual void num_ceren_2(double val) {
        m_container.num_ceren_2(m_idx, val);
    }
