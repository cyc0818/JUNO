...
namespace opsimulator {
    ...
    bool G4GenStepContainer::clear() {
        ...
        m_post_betas.clear();
        m_num_cerens.clear();
        m_num_ceren_1s.clear();
        m_num_ceren_2s.clear();
    ...
    int G4GenStepContainer::new_entry() {
        ...
        m_pre_betas.push_back(0);
        m_post_betas.push_back(0);
        m_num_cerens.push_back(0);
        m_num_ceren_1s.push_back(0);
        m_num_ceren_2s.push_back(0);
    ...
    // ceren
    double G4GenStepContainer::pre_beta(int idx) {
        return m_pre_betas[idx];
    }

    void G4GenStepContainer::pre_beta(int idx, double val) {
        m_pre_betas[idx] = val;
    }

    double G4GenStepContainer::post_beta(int idx) {
        return m_post_betas[idx];
    }

    void G4GenStepContainer::post_beta(int idx, double val) {
        m_post_betas[idx] = val;
    }

    double G4GenStepContainer::num_ceren(int idx) {
        return m_num_cerens[idx];
    }

    void G4GenStepContainer::num_ceren(int idx, double val) {
        m_num_cerens[idx] = val;
    }

    double G4GenStepContainer::num_ceren_1(int idx) {
        return m_num_ceren_1s[idx];
    }

    void G4GenStepContainer::num_ceren_1(int idx, double val) {
        m_num_ceren_1s[idx] = val;
    }

    double G4GenStepContainer::num_ceren_2(int idx) {
        return m_num_ceren_2s[idx];
    }

    void G4GenStepContainer::num_ceren_2(int idx, double val) {
        m_num_ceren_2s[idx] = val;
    }
