...
#ifndef DsG4ScintSimple_h
#define DsG4ScintSimple_h 1
...
class DsG4ScintSimple : public G4VRestDiscreteProcess, public G4UImessenger
...
public: // Without description
	...
	DsG4ScintSimple(const G4String& processName = "Scintillation",
                          G4ProcessType type = fElectromagnetic);

	// DsG4ScintSimple(const DsG4ScintSimple &right);
...
public: // With description
        ...
        // DsG4ScintSimple Process has both PostStepDoIt (for energy 
	...
	void SetTrackSecondariesFirst(const G4bool state);
       ...
       G4bool GetUseFastMu300nsTrick() const;
        ...
        void SetBirksConstant1(const std::map<int, double> &m1) { birksConstant1 = m1; }
        std::map<int, double>& GetBirksConstant1() { return birksConstant1; }
        void SetBirksConstant2(const std::map<int, double> &m2) { birksConstant2 = m2; }
        std::map<int, double>& GetBirksConstant2() { return birksConstant2; }
...
protected:
        ...
        std::map<int, double> birksConstant1;
        std::map<int, double> birksConstant2;
...
inline 
void DsG4ScintSimple::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool DsG4ScintSimple::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void DsG4ScintSimple::SetScintillationYieldFactor(const G4double yieldfactor)
{
...
inline
G4double DsG4ScintSimple::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline 
void DsG4ScintSimple::SetUseFastMu300nsTrick(const G4bool fastMu300nsTrick)
{
        FastMu300nsTrick = fastMu300nsTrick;
}

inline 
G4bool DsG4ScintSimple::GetUseFastMu300nsTrick() const
{
...
inline
void DsG4ScintSimple::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double DsG4ScintSimple::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

inline
G4PhysicsTable* DsG4ScintSimple::GetSlowIntegralTable() const
{
        return theSlowIntegralTable;
}

inline
G4PhysicsTable* DsG4ScintSimple::GetFastIntegralTable() const
{
        return theFastIntegralTable;
}

inline
G4PhysicsTable* DsG4ScintSimple::GetReemissionIntegralTable() const
{
 	return theReemissionIntegralTable;
}

inline
void DsG4ScintSimple::DumpPhysicsTable() const
{
