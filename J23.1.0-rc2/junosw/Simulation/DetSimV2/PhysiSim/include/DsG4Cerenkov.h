...
public: // With description
	...
	void SetMaxNumPhotonsPerStep(const G4int NumPhotons);
        ...
        void SetCerenkovYieldFactor(const G4double yieldFactor);
        G4double GetCerenkovYieldFactor() const;
private:
...
private:
    ...
    G4double m_cerenkovYieldFactor;
};
...
inline
void DsG4Cerenkov::SetCerenkovYieldFactor(const G4double yieldFactor)
{
    m_cerenkovYieldFactor = yieldFactor;
}
