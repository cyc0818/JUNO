...
public:
  ...
  void SetOpticksMode(const G4int opticksMode); 
  G4int GetOpticksMode() const ;  
...
inline
void G4Cerenkov_modified::SetOpticksMode(const G4int opticksMode)
{
    m_opticksMode = opticksMode ; 
}

inline 
G4int G4Cerenkov_modified::GetOpticksMode() const 
{
   return m_opticksMode ; 
}
