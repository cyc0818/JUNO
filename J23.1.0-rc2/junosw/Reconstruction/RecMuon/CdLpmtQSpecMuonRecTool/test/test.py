...
roSvc.property("OutputStreams").set({"/Event/Sim": "sample_muonrec_lpmt.root", "/Event/RecTrack": "sample_muonrec_lpmt.root", "/Event/Calib":"sample_muonrec_lpmt.root"})
...
recalg.rectool.property("PECut").set(1000)
