...
TOTALPMTS = {"Acrylic": 55000, "Balloon": 18306}
...
if __name__  ==  "__main__":
    ...
    recalg.property("Pmt20inchTimeReso").set(5)            # ns
    recalg.useRecTool("ConeMuonRecTool")
    ...
    recalg.rectool.property("KDEFileSPMT").set("$RECMU_CONE_DATA/PDF_SPMT.root")
    recalg.rectool.property("KDEFileLPMT").set("$RECMU_CONE_DATA/PDF_LPMT.root")
    recalg.rectool.property("generateUserOutput").set(True)
    recalg.rectool.property("UserOutfile").set(args.userout)
    recalg.rectool.property("CleaningTime").set(5)
    #recalg.rectool.property("PMTCleaning").set(False)
