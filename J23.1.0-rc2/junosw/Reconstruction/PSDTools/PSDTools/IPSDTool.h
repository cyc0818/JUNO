...
class IPSDTool{
    public:
        ...
        //This argument is to tag the event that fails in preProcess() because of a null RecHeader. If this argument is true, it will directly set PSDVal as -50 and skip PSDval calculation to avoid a crash.
        virtual double CalPSDVal(bool ) = 0;

        void SetEvtID(int evtID){m_evtID = evtID;}
