...
bool MuonWaveRec::initialize(){
  ...
  m_calib = svc->bookTree(*m_par, "USER_OUTPUT/MuonWaveRec", "simple output of calibration data");
...
bool MuonWaveRec::waveReco(const JM::ElecWaveform &channel, std::vector<float> &charge, std::vector<float> &time, float &riseTime){
