...
juno_application = JUNOApplication(description="JUNO Waveform Reconstruction")
juno_application.set_default_input("sample_elecsim.root")
juno_application.set_default_output("sample_calib.root")
juno_application.set_default_user_output("sample_calib_user.root")
