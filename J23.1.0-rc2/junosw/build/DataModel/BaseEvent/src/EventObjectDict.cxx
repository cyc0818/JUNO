...
#define R__DICTIONARY_FILENAME dIjunofsdIusersdIyuchinchengdIJ23dO1dO0mIrc2dIjunoswdIbuilddIDataModeldIBaseEventdIsrcdIEventObjectDict
...
#include "/junofs/users/yuchincheng/J23.1.0-rc2/junosw/build/DataModel/BaseEvent/Event/EventObject.h"
...
namespace ROOT {
   static void *new_JMcLcLEventObject(void *p = nullptr);
   ...
   {
      ::JM::EventObject *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::JM::EventObject >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("JM::EventObject", ::JM::EventObject::Class_Version(), "Event/EventObject.h", 37,
   ...
   {
      return GenerateInitInstanceLocal((::JM::EventObject*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::JM::EventObject*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace JM {
//______________________________________________________________________________
atomic_TClass_ptr EventObject::fgIsA(nullptr);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::JM::EventObject*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int EventObject::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::JM::EventObject*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *EventObject::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::JM::EventObject*)nullptr)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::JM::EventObject*)nullptr)->GetClass(); }
   return fgIsA;
}
...
namespace JM{class __attribute__((annotate("$clingAutoload$Event/EventObject.h")))  EventObject;}
)DICTFWDDCLS";
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("EventObjectDict",
        ...
        TriggerDictionaryInitialization_EventObjectDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
