...
class JunoDetectorID
{
    ...
    protected:
        ...
        static const unsigned int CD_ID      = 0x1;
        static const unsigned int WP_ID      = 0x2;
        static const unsigned int TT_ID      = 0x3;
        
        static const unsigned int SUB_INDEX   = 28;
        static const unsigned int SUB_MASK    = 0xF0000000;
