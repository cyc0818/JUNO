...
class InputElementKeeper {
    ...
    private:
        ...
        typedef std::map<int, std::vector<std::string> > PathMap;
    ...
    public:
        ...
        static InputElementKeeper* GetInputElementKeeper();
        ...
        // Get the NavPath of a file
        std::vector<std::string>& GetNavPath(int fileid);
        // Get file name
