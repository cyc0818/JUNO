// Author: Jinnan Zhang & Zhao Xin in 03/07/2022
// This cross section is based on arXiv:astro-ph/0302055v2
...
private:
  ReadIBDXSecParam * gReader = new ReadIBDXSecParam();
  double h_x = 1e-5;
  ...
  double fMa;           //  axial mass squared
  double fMa2;           //  axial mass squared
  double fMv;           //  vector mass squared
  ...
  double E_Lower = 1.806;
};

Double_t gKRLSigmaTotal(Double_t* x, Double_t*a);


R__EXTERN IBDXSec* gInverseBeta;
