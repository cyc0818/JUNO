...
class ConfAcrylic(object):
    ...
    def disable_pmts_and_struts_in_cd(self):
        ...
        self._factory.property("Strut2PosFile").set("")
...
#        print upperchim_pos
    ...
    def set_veto_pmt_mode(self, mode="FileMode"):
    ...
    def ion_process(self):
        if self._ion_process is None:
            self._ion_process = self.tool("DsWrapPhysConsIon")
        return self._ion_process
