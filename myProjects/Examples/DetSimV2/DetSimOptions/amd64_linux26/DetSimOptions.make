...
#
#   Generated Fri Nov 20 00:27:47 2020  by lint
#
#====================================
...
$(DetSimOptionslib) :: $(bin)LSExpParticleGun.o $(bin)LSExpPhysicsList.o $(bin)LSExpEventAction.o $(bin)LSExpDetectorConstruction.o $(bin)LSExpActionInitialization.o $(bin)LSExpSteppingAction.o $(bin)LSExpPrimaryGeneratorAction.o $(bin)ExpHallConstruction.o $(bin)RockConstruction.o $(bin)LSExpTrackingAction.o $(bin)LSExpRunAction.o $(bin)DetPrototypeSvc.o $(bin)DetSim0Svc.o $(bin)GlobalGeomInfo.o $(bin)WaterPoolConstruction.o
...
DetSimOptionsclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)LSExpParticleGun.o $(bin)LSExpPhysicsList.o $(bin)LSExpEventAction.o $(bin)LSExpDetectorConstruction.o $(bin)LSExpActionInitialization.o $(bin)LSExpSteppingAction.o $(bin)LSExpPrimaryGeneratorAction.o $(bin)ExpHallConstruction.o $(bin)RockConstruction.o $(bin)LSExpTrackingAction.o $(bin)LSExpRunAction.o $(bin)DetPrototypeSvc.o $(bin)DetSim0Svc.o $(bin)GlobalGeomInfo.o $(bin)WaterPoolConstruction.o
	$(cleanup_silent) /bin/rm -f $(patsubst %.o,%.d,$(bin)LSExpParticleGun.o $(bin)LSExpPhysicsList.o $(bin)LSExpEventAction.o $(bin)LSExpDetectorConstruction.o $(bin)LSExpActionInitialization.o $(bin)LSExpSteppingAction.o $(bin)LSExpPrimaryGeneratorAction.o $(bin)ExpHallConstruction.o $(bin)RockConstruction.o $(bin)LSExpTrackingAction.o $(bin)LSExpRunAction.o $(bin)DetPrototypeSvc.o $(bin)DetSim0Svc.o $(bin)GlobalGeomInfo.o $(bin)WaterPoolConstruction.o) $(patsubst %.o,%.dep,$(bin)LSExpParticleGun.o $(bin)LSExpPhysicsList.o $(bin)LSExpEventAction.o $(bin)LSExpDetectorConstruction.o $(bin)LSExpActionInitialization.o $(bin)LSExpSteppingAction.o $(bin)LSExpPrimaryGeneratorAction.o $(bin)ExpHallConstruction.o $(bin)RockConstruction.o $(bin)LSExpTrackingAction.o $(bin)LSExpRunAction.o $(bin)DetPrototypeSvc.o $(bin)DetSim0Svc.o $(bin)GlobalGeomInfo.o $(bin)WaterPoolConstruction.o) $(patsubst %.o,%.d.stamp,$(bin)LSExpParticleGun.o $(bin)LSExpPhysicsList.o $(bin)LSExpEventAction.o $(bin)LSExpDetectorConstruction.o $(bin)LSExpActionInitialization.o $(bin)LSExpSteppingAction.o $(bin)LSExpPrimaryGeneratorAction.o $(bin)ExpHallConstruction.o $(bin)RockConstruction.o $(bin)LSExpTrackingAction.o $(bin)LSExpRunAction.o $(bin)DetPrototypeSvc.o $(bin)DetSim0Svc.o $(bin)GlobalGeomInfo.o $(bin)WaterPoolConstruction.o)
...
$(bin)DetSimOptions_dependencies.make : $(use_requirements) $(cmt_final_setup_DetSimOptions)
	$(echo) "(DetSimOptions.make) Rebuilding $@"; \
	  $(build_dependencies) -out=$@ -start_all $(src)LSExpParticleGun.cc $(src)LSExpPhysicsList.cc $(src)LSExpEventAction.cc $(src)LSExpDetectorConstruction.cc $(src)LSExpActionInitialization.cc $(src)LSExpSteppingAction.cc $(src)LSExpPrimaryGeneratorAction.cc $(src)ExpHallConstruction.cc $(src)RockConstruction.cc $(src)LSExpTrackingAction.cc $(src)LSExpRunAction.cc $(src)DetPrototypeSvc.cc $(src)DetSim0Svc.cc $(src)GlobalGeomInfo.cc $(src)WaterPoolConstruction.cc -end_all $(includes) $(app_DetSimOptions_cppflags) $(lib_DetSimOptions_cppflags) -name=DetSimOptions $? -f=$(cmt_dependencies_in_DetSimOptions) -without_cmt
