...
MCGlobalTimeSvc_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(MCGlobalTimeSvc_use_linkopts)
MCGlobalTimeSvc_use_linkopts=    $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
MCGlobalTimeSvc_stamps=${MCGLOBALTIMESVCROOT}/${BINDIR}/MCGlobalTimeSvc.stamp 
MCGlobalTimeSvc_linker_library=MCGlobalTimeSvc
tag=amd64_linux26
package=MCGlobalTimeSvc
version=v0
PACKAGE_ROOT=$(MCGLOBALTIMESVCROOT)
srcdir=../src
bin=../$(MCGlobalTimeSvc_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre1/offline/Simulation/DetSimV2/MCGlobalTimeSvc/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(MCGlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
...
use_stamps=  $(MCGlobalTimeSvc_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(MCGlobalTimeSvc_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(MCGlobalTimeSvc_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(MCGlobalTimeSvc_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(MCGlobalTimeSvc_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(MCGlobalTimeSvc_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(MCGlobalTimeSvc_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries)  $(CLHEP_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
MCGlobalTimeSvc_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
MCGlobalTimeSvc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes MCGlobalTimeSvc_python MCGlobalTimeSvc 
all_constituents= $(constituents)
constituentsclean= MCGlobalTimeSvcclean MCGlobalTimeSvc_pythonclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
MCGlobalTimeSvcprototype_dependencies= $(MCGlobalTimeSvccompile_dependencies)
