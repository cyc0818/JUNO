...
double Hello_PMTSolid::delta_torlerance = 1E-2*mm;

Hello_PMTSolid::Hello_PMTSolid(
        double R1, double R2, double R3, double H)
    : m_R1(R1), m_R2(R2), m_R3(R3), m_H(H), numSide(4) {
...
G4VSolid*
Hello_PMTSolid::GetSolid(G4String solidname, double thickness) {
...
G4VSolid*
Hello_PMTSolid::GetCoverTop(G4String solidname, 
                            G4double c_h1,
                            G4double c_r1,
                            G4double c_h2,
                            G4double c_r2,
...
G4VSolid*
Hello_PMTSolid::GetCoverBottom(G4String solidname, 
                            G4double c_h2,
                            G4double c_r2,
                            G4double c_h3,
                            G4double c_r3,
...
G4VSolid* 
Hello_PMTSolid::GetCoverSolid(G4String solidname, 
                            G4double c_h1,
                            G4double c_r1,
                            G4double c_h2,
                            G4double c_r2,
...
G4VSolid* 
Hello_PMTSolid::GetCoverTopCurve(G4String solidname,
                            G4double c_h1,
                            G4double c_r1,
                            G4double c_h2,
                            G4double c_r2,
...
G4VSolid* 
Hello_PMTSolid::GetCoverSolidWithTopCurve(G4String solidname, 
                            G4double c_h0,
                            G4double c_r0,
                            G4double c_h1,
                            G4double c_r1,
