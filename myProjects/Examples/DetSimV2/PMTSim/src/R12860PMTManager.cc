...
DECLARE_TOOL(R12860PMTManager);

// Interface
G4LogicalVolume* 
R12860PMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
void
R12860PMTManager::init_material() {
...
void
R12860PMTManager::init_variables() {
    m_pmt_r = 254.*mm;
    m_pmt_h = 523.*mm;
...
void
R12860PMTManager::init_mirror_surface() {
...
void 
R12860PMTManager::helper_make_solid() 
{
...
void
R12860PMTManager::helper_make_logical_volume()
{
...
void
R12860PMTManager::helper_make_physical_volume()
{
...
void
R12860PMTManager::helper_make_optical_surface()
{
...
void
R12860PMTManager::helper_fast_sim()
{
...
void
R12860PMTManager::helper_vis_attr()
{  
