...
#include "Hello3inchPMTManager.hh"
...
DECLARE_TOOL(Hello3inchPMTManager);

// Interface
G4LogicalVolume* 
Hello3inchPMTManager::getLV() {
    if (!m_logical_pmt) {
        init();
    }
...
G4double
Hello3inchPMTManager::GetPMTRadius() {
    if (!getLV()) {
...
G4double
Hello3inchPMTManager::GetPMTHeight() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_pmt_h;
...
G4double
Hello3inchPMTManager::GetZEquator() {
    if (!getLV()) {
        LogError << "Can't initialize PMT." << std::endl;;
    }
    return m_z_equator;
...
G4ThreeVector
Hello3inchPMTManager::GetPosInPMT() {
    G4ThreeVector rndm_pos;
    return rndm_pos;
}

// Constructor
Hello3inchPMTManager::Hello3inchPMTManager
...
void
Hello3inchPMTManager::init_material() {
...
void
Hello3inchPMTManager::init_variables() {
    m_pmt_r = 254.*mm*(3./20.); // scale the 20inch to 3inch
    m_pmt_h = 700.*mm*(3./20.);
...
void
Hello3inchPMTManager::init_mirror_surface() {
...
void 
Hello3inchPMTManager::helper_make_solid() 
{
...
void
Hello3inchPMTManager::helper_make_logical_volume()
{
...
void
Hello3inchPMTManager::helper_make_physical_volume()
{
...
void
Hello3inchPMTManager::helper_make_optical_surface()
{
...
void
Hello3inchPMTManager::helper_fast_sim()
{
...
void
Hello3inchPMTManager::helper_vis_attr()
{
