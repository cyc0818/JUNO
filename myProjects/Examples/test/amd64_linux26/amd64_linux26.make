...
test_tag=$(tag)
TESTROOT=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test
test_root=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test
TESTVERSION=v0
test_cmtpath=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects
test_offset=Examples
test_project=myProjects
...
test_linkopts= -ltest 
test_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(test_use_linkopts)
test_use_linkopts=    $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
test_stamps=${TESTROOT}/${BINDIR}/test.stamp 
test_linker_library=test
tag=amd64_linux26
package=test
version=v0
...
javabin=../classes/
mgrdir=cmt
BIN=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test/amd64_linux26/
project=myProjects
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin $(ExternalInterface_installarea_prefix)/$(CMTCONFIG)/lib $(ExternalInterface_installarea_prefix)/share/lib $(ExternalInterface_installarea_prefix)/share/bin $(sniper_installarea_prefix)/$(CMTCONFIG)/lib $(sniper_installarea_prefix)/share/lib $(sniper_installarea_prefix)/share/bin $(mt.sniper_installarea_prefix)/$(CMTCONFIG)/lib $(mt.sniper_installarea_prefix)/share/lib $(mt.sniper_installarea_prefix)/share/bin $(offline_installarea_prefix)/$(CMTCONFIG)/lib $(offline_installarea_prefix)/share/lib $(offline_installarea_prefix)/share/bin $(Examples_installarea_prefix)/$(CMTCONFIG)/lib $(Examples_installarea_prefix)/share/lib $(Examples_installarea_prefix)/share/bin $(myProjects_installarea_prefix)/$(CMTCONFIG)/lib $(myProjects_installarea_prefix)/share/lib $(myProjects_installarea_prefix)/share/bin
use_linkopts= $(cmt_installarea_linkopts)   $(test_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
Examples_home=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test
...
Examples_install_include= /afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test/$(Examples_installarea_prefix)/include 
...
ExternalInterface_install_include= /cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre1/ExternalInterface/$(ExternalInterface_installarea_prefix)/include 
ExternalInterface_python_path=/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre1/ExternalInterface/$(ExternalInterface_installarea_prefix)/$(tag)/lib
...
Examples_python_path=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test/$(Examples_installarea_prefix)/$(tag)/lib
myProjects_python_path=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/$(myProjects_installarea_prefix)/$(tag)/lib
ExternalInterface_install_python=/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre1/ExternalInterface/$(ExternalInterface_installarea_prefix)/python
...
Examples_install_python=/afs/ihep.ac.cn/users/y/yuchincheng/myProjects/Examples/test/$(Examples_installarea_prefix)/python
...
use_stamps=  $(test_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(test_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(test_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(test_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(test_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(test_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(test_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
...
testprototype_dependencies= $(testcompile_dependencies)
