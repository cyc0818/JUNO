...
${CMTROOT}/mgr/cmt cleanup -csh -pack=DetSimOptions -version=v0 -path=/junofs/users/yuchincheng/myProjects/Examples  $* >${cmtDetSimOptionstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=DetSimOptions -version=v0 -path=/junofs/users/yuchincheng/myProjects/Examples  $* >${cmtDetSimOptionstempfile}"
